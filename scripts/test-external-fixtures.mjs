...
if (report.totalCaseCount !== 52) failures.push(`totalCaseCount=${report.totalCaseCount}`);
if (report.totalPassedCount !== 52) failures.push(`totalPassedCount=${report.totalPassedCount}`);
...
if (!gmosRun || gmosRun.caseCount !== 42 || gmosRun.pass !== true) {
  failures.push("curated-gmos run did not pass 42 cases");
}
