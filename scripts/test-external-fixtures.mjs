...
if (report.totalCaseCount !== 41) failures.push(`totalCaseCount=${report.totalCaseCount}`);
if (report.totalPassedCount !== 41) failures.push(`totalPassedCount=${report.totalPassedCount}`);
...
if (!gmosRun || gmosRun.caseCount !== 35 || gmosRun.pass !== true) {
  failures.push("curated-gmos run did not pass 35 cases");
}
