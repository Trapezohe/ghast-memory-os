// Non-production fixture for historical downstream regression tests.
//
// This intentionally preserves the old broad linguistic rule extractor so tests
// can exercise world-belief/update/materialization paths without requiring a
// network LLM. It must never be imported from src/ or exposed as SDK fallback.
import type {
